...
def make_membership(
    user=None, organisation=None, role=Membership.Role.MEMBER, **kwargs
):
    ...
    return Membership.objects.create(
        user=user, organisation=organisation, role=role, **kwargs
    )
...
def make_invitation(organisation=None, invited_by=None, **kwargs):
    ...
    return Invitation.objects.create(
        organisation=organisation, invited_by=invited_by, **defaults
    )
