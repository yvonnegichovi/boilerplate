...
export default function LoginPage() {
    ...
    return (
        ...
        >
            ...
            <button
                type="submit"
                className="w-full py-3 px-4 rounded-xl bg-purple-600 hover:bg-purple-700 text-white font-medium text-sm flex items-center justify-center space-x-2 shadow-lg shadow-purple-500/25 transition-all duration-200 active:scale-98 mt-2"
            >
                <span>Continue</span>
